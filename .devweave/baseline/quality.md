...
- `vscode-extension/npm test`：23 項通過，涵蓋 BootstrapInstaller blank/conflict/idempotent/hash/path/symlink/rollback/date/Windows-POSIX、protocol、snapshot、prompt 與 security regression。
