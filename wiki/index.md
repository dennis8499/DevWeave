...
- [[devweave-knowledge-workflow]] | Bootstrap/Query/Review/Promotion、唯一 router 的 Plan-first G1/G2/Gate routing、high-risk isolated reviewer，以及 shared evaluator、frozen plan、release-only dependency policy 與 G3 evidence parity
