...
4. Run targeted repository verification and add evidence when useful.
5. Mark the task complete only with evidence IDs or a concrete completion note.
6. Continue until every approved task is complete or one explicit blocker remains.
